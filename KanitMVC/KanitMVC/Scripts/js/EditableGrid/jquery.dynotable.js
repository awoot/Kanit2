...
(function ($) {
    ...
    $.fn.extend({
        dynoTable2: function (options) {
            ...
            var defaults = {
                removeClass: '.row-remover',
                cloneClass: '.row-cloner',
                addRowTemplateId: '#add-template2',
                addRowButtonId: '#add-row2',
                lastRowRemovable: true,
                orderable: true,
                dragHandleClass: ".drag-handle",
                insertFadeSpeed: "slow",
    ...
    $.fn.extend({
        dynoTable3: function (options) {
            ...
            var defaults = {
                removeClass: '.row-remover',
                cloneClass: '.row-cloner',
                addRowTemplateId: '#add-template3',
                addRowButtonId: '#add-row3',
                lastRowRemovable: true,
                orderable: true,
                dragHandleClass: ".drag-handle",
                insertFadeSpeed: "slow",
    ...
    $.fn.extend({
        dynoTable4: function (options) {
            ...
            var defaults = {
                removeClass: '.row-remover',
                cloneClass: '.row-cloner',
                addRowTemplateId: '#add-template4',
                addRowButtonId: '#add-row4',
                lastRowRemovable: true,
                orderable: true,
                dragHandleClass: ".drag-handle",
                insertFadeSpeed: "slow",
    ...
    $.fn.extend({
        dynoTable5: function (options) {
            ...
            var defaults = {
                removeClass: '.row-remover',
                cloneClass: '.row-cloner',
                addRowTemplateId: '#add-template5',
                addRowButtonId: '#add-row5',
                lastRowRemovable: true,
                orderable: true,
                dragHandleClass: ".drag-handle",
                insertFadeSpeed: "slow",
    ...
    $.fn.extend({
        dynoTable6: function (options) {
            ...
            var defaults = {
                removeClass: '.row-remover',
                cloneClass: '.row-cloner',
                addRowTemplateId: '#add-template6',
                addRowButtonId: '#add-row6',
                lastRowRemovable: true,
                orderable: true,
                dragHandleClass: ".drag-handle",
                insertFadeSpeed: "slow",
    ...
    $.fn.extend({
        dynoTable7: function (options) {
            ...
            var defaults = {
                removeClass: '.row-remover',
                cloneClass: '.row-cloner',
                addRowTemplateId: '#add-template7',
                addRowButtonId: '#add-row7',
                lastRowRemovable: true,
                orderable: true,
                dragHandleClass: ".drag-handle",
                insertFadeSpeed: "slow",
    ...
    $.fn.extend({
        dynoTable8: function (options) {
            ...
            var defaults = {
                removeClass: '.row-remover',
                cloneClass: '.row-cloner',
                addRowTemplateId: '#add-template8',
                addRowButtonId: '#add-row8',
                lastRowRemovable: true,
                orderable: true,
                dragHandleClass: ".drag-handle",
                insertFadeSpeed: "slow",
    ...
    //Requisition เพิ่มของอื่นๆ เช่น เชือก, กล่องเครื่องมือ
    $.fn.extend({
        dynoTable11: function (options) {

            var defaults = {
                removeClass: '.row-remover',
                cloneClass: '.row-cloner',
                addRowTemplateId: '#add-template11',
                addRowButtonId: '#add-row11',
                lastRowRemovable: true,
                orderable: true,
                dragHandleClass: ".drag-handle",
                insertFadeSpeed: "slow",
